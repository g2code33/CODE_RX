...
- PHANTOM-controlled document sharing: separate global and per-member Share-button and Download-button controls. Links are random, read-only, non-expiring until revoked, and can independently allow or block shared-page download/print. They never expose protected attachments or sensitive/restricted documents.
