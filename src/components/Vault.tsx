...
export const Vault = ({ compact = false, workspaceMode = 'member', onBack }: { compact?: boolean; workspaceMode?: VaultMode; onBack?: () => void }) => {
  ...
  const chooseSection = (section: any) => {
    setActiveSection(section); setShowHome(false); setShowArchived(false); setShowArchivedProjects(false); setEditorOpen(false); setSelectedDocument(null); setSearchResults([]); setMobileNavigationOpen(false);
  };
