    ...
    <section id="learn" className="brand-section brand-grid py-28 sm:py-36">
      ...
      <div className="relative z-10 mx-auto grid max-w-[1440px] items-center gap-16 px-5 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
        ...
        <div className="brand-card relative overflow-hidden p-5 sm:p-8">
          ...
          <div className="relative mb-7 flex items-center justify-between border-b border-[#b8ff3d]/15 pb-5">
            <div className="flex items-center gap-3"><Terminal className="h-4 w-4 text-[#b8ff3d]" /><span className="brand-number">LEARNING_PATH / 08 MODULES</span></div>
          ...
          <div className="relative mt-7 flex items-center justify-between border-t border-[#b8ff3d]/15 pt-5 text-[0.65rem] font-black uppercase tracking-[0.17em] text-[#94a992]">
            <span>Start anywhere</span><span className="text-[#b8ff3d]">Keep building →</span>
          </div>
        </div>
      </div>
    </section>
