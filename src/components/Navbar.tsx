          ...
          <div className="hidden md:flex items-center space-x-1">
            {!isDashboard && NAV_LINKS.map((link) => (
              <button
                ...
                className={`px-4 py-2 text-sm font-bold transition-all uppercase tracking-wide rounded-lg ${
                  activeTab === link.id 
            ...
            <button
              ...
              className="bg-emerald-500 text-white px-8 py-3 rounded-full font-bold text-sm hover:bg-emerald-600 transition-all transform hover:scale-105 ml-4 shadow-lg shadow-emerald-200"
            >
