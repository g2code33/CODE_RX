      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-10">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <div className="brand-card p-7 sm:p-9">
            ...
            <p className="mt-6 max-w-xl text-sm leading-7 text-[#a9bda3]">We collaborate with universities, pharmacy organizations, and technology teams to bridge the gap between care and code.</p>
            <div className="mt-7 grid grid-cols-2 gap-2">
              {['UCC Pharmacy', 'PharmaLink', 'TechHealth', 'MediCode'].map((partner) => <div key={partner} className="rounded-lg border border-[#b8ff3d]/12 bg-[#b8ff3d]/5 px-3 py-4 text-center text-[0.66rem] font-bold uppercase tracking-wide text-[#a9bf9f]">{partner}</div>)}
            </div>
