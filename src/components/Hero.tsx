    ...
    <section id="home" className="brand-section brand-grid min-h-[720px] pt-[4.5rem] lg:min-h-screen">
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-4.5rem)] max-w-[1440px] items-center gap-14 px-5 py-16 sm:px-8 lg:grid-cols-[1.03fr_0.97fr] lg:gap-10 lg:px-10 lg:py-20">
        ...
        >
          ...
          <div className="mt-12 grid max-w-xl grid-cols-3 divide-x divide-[#b8ff3d]/15 border-y border-[#16a34a]/20 py-5">
            <div className="pr-4">
              <p className="brand-number">{String(content.communityCount).padStart(3, '0')}+</p>
              <p className="mt-1 text-[0.66rem] font-bold uppercase tracking-[0.16em] text-[#475569]">Members</p>
            </div>
            <div className="px-4">
              <p className="brand-number">06</p>
              <p className="mt-1 text-[0.66rem] font-bold uppercase tracking-[0.16em] text-[#475569]">Tracks</p>
            </div>
            <div className="pl-4">
              <p className="brand-number">24/7</p>
              <p className="mt-1 text-[0.66rem] font-bold uppercase tracking-[0.16em] text-[#475569]">Curiosity</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="brand-card relative aspect-square overflow-hidden rounded-[2rem] border-[#16a34a]/20 bg-[#06100a]/80 p-5 shadow-[0_0_100px_rgba(91,255,32,0.09)] sm:p-8">
            ...
            <div className="absolute left-8 top-8 flex items-center gap-2 text-[0.64rem] font-black uppercase tracking-[0.2em] text-[#475569] sm:left-12 sm:top-12">
            ...
            <div className="absolute right-8 top-8 text-right sm:right-12 sm:top-12">
              ...
              <p className="mt-1 text-[0.66rem] uppercase tracking-[0.17em] text-[#64748b]">Est. Ghana</p>
            </div>

            <div className="relative flex h-full items-center justify-center">
              <div className="absolute h-[68%] w-[68%] rounded-full border border-[#16a34a]/20 shadow-[0_0_60px_rgba(184,255,61,0.13),inset_0_0_45px_rgba(184,255,61,0.08)]" />
              <div className="absolute h-[76%] w-[76%] rounded-full border border-dashed border-[#16a34a]/20" />
              <img
                src="/logo.png"
            ...
            <div className="absolute bottom-8 left-8 right-8 flex items-end justify-between sm:bottom-12 sm:left-12 sm:right-12">
              <div>
                <p className="text-[0.64rem] font-black uppercase tracking-[0.2em] text-[#64748b]">Signal</p>
              ...
              <div className="flex gap-2">
                <span className="grid h-8 w-8 place-items-center rounded-lg border border-[#16a34a]/20 bg-[#b8ff3d]/5 text-[#15803d]"><Code2 className="h-3.5 w-3.5" /></span>
                <span className="grid h-8 w-8 place-items-center rounded-lg border border-[#16a34a]/20 bg-[#b8ff3d]/5 text-[#15803d]"><Activity className="h-3.5 w-3.5" /></span>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-2 text-[0.64rem] font-black uppercase tracking-[0.18em] text-[#15803d]">
              <Zap className="h-3.5 w-3.5" />
              Build signal
            </div>
            <p className="mt-3 text-sm font-bold text-[#0f172a]">Pharmacy problems → digital solutions</p>
          ...
          <div className="brand-card absolute -right-2 -top-6 hidden w-44 p-4 sm:block sm:-right-7">
            <div className="flex items-center gap-2 text-[0.64rem] font-black uppercase tracking-[0.18em] text-[#475569]"><ShieldCheck className="h-3.5 w-3.5 text-[#15803d]" /> Safe by design</div>
            <p className="mt-2 text-xs leading-relaxed text-[#475569]">Responsible tech for better care.</p>
          </div>
        </motion.div>
      </div>
    </section>
