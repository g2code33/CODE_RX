...
export const CommunityHub = ({
  ...
  onBack?: () => void;
  onHome?: () => void;
  initialArea?: 'public' | 'private';
  standalone?: boolean;
  backLabel?: string;
}) => {
  const [area, setArea] = useState<'public' | 'private'>(initialArea);
