...
const EVENT_LABELS: Record<string, string> = {
  ...
  DOCUMENT_SAVED: 'Saved a revision',
  DOCUMENT_SENT: 'Sent a document to Code Rx',
  DOCUMENT_REVIEWED: 'Answered the review on a document',
  DOCUMENT_SIGNED: 'Signed a document',
  MESSAGE_SENT: 'Sent a message to PHANTOM',
